...
class DetailPagesViewModel {
  final saveCase = ValueNotifier<Case<DetailPagesModel>>(Case());
  final getCase = ValueNotifier<Case<DetailPagesModel>>(Case());
  ...
  void listener(DetailPagesController controller) {
